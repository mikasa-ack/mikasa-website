...
There are several [input](/GoL%20frontend/project.md#input) folder names and files within a Retype project that incorporate special behaviour. All paths for folders or files within Retype are relative to your project [input](/GoL%20frontend/project.md#input) directory.
...
- All blog pages are set with the [`layout: blog`](/GoL%20frontend/page.md#layout) layout, unless otherwise specified in the page metadata.

!!!
Be sure to review the [`author`](/GoL%20frontend/page.md#author) and [`date`](/GoL%20frontend/page.md#date) Page configs if you are writing blog posts.
!!!

### /categories

The default index page of the `/categories` directory is reserved for a summary of any [category](/GoL%20frontend/page.md#category) configs. Every category configured within an `.md` page of your Retype project will have a corresponding entry here.
...
Any files placed within this directory will be copied to the [output](/GoL%20frontend/project.md#output) directory. Please see the [`include`](/GoL%20frontend/project.md#include) and [`exclude`](/GoL%20frontend/project.md#exclude) configs for fine-grained control over including or excluding files or folders.

### /tags

The `/tags` directory is reserved for [tags](/GoL%20frontend/page.md#tags). Every tag name configured within an `.md` page will have a corresponding entry here.
...
A `CNAME` file will be automatically created if the [`url`](/GoL%20frontend/project.md#url) is configured with a domain or sub-domain.
...
If you manually create a `CNAME` file within the root of the [input](/GoL%20frontend/project.md#input) folder of your project, Retype will not automatically create the `CNAME` file, even if the [`url`](/GoL%20frontend/project.md#url) or [`cname`](/GoL%20frontend/project.md#cname) is configured or conflicts.
